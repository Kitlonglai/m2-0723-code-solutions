...
const vOne = v1 && console.log('v1 is truthy');
const vTwo = v2 && console.log('v2 is truthy');
...
const config1 = v1 || { value: 'default-value' };
...
const cfg1 = v1 ?? { value: 'default-value' };
...
const tern1 = v1 ? { value: 'truthy' } : { value: 'falsy' };
